...
public class WebSecurityCsrfConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin().loginPage("/user/showLogin").loginProcessingUrl("/user/login")
...
//        http.authorizeRequests().antMatchers("/user/login","/login.html","/error.html").permitAll();
        ...
        http.authorizeRequests().antMatchers("/user/login","/login.html","/error.html","/user/showLogin").permitAll();
