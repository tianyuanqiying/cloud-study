...
import com.cloud.study.springsecurity.handler.AppAccessDeniedHandler;
 ...
 */
//@Configuration
public class WebSecurityDeniedHandlerConfig extends WebSecurityConfigurerAdapter {
    @Autowired
...
//        http.authorizeRequests().antMatchers("/user/login","/login.html","/error.html").permitAll();
        ...
        //403处理器
        http.exceptionHandling().accessDeniedHandler(new AppAccessDeniedHandler());
