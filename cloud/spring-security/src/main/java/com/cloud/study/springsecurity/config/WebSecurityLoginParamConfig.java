 ...
 */
//@Configuration
public class WebSecurityLoginParamConfig extends WebSecurityConfigurerAdapter{
    @Autowired
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin().loginPage("/login2.html")
...
//        http.authorizeRequests().antMatchers("/user/login","/login.html","/error.html").permitAll();
        ...
        http.authorizeRequests().antMatchers("/user/login","/login2.html","/error.html").permitAll();
        //非登录的URL需要认证
