 ...
 */
//@Configuration
public class WebSecurityRemenberMeConfig extends WebSecurityConfigurerAdapter{
    @Autowired
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //记住我
        http.rememberMe().userDetailsService(userServiceInDB).tokenRepository(persistentTokenRepository()).tokenValiditySeconds(3600);
